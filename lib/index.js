...
var warning$1 = process.env.NODE_ENV !== "production" ? function warning(condition, format) {
...
function deprecate(propType, message) {
  function checker(props, propName, componentName) {
    ...
    if (!didWarnAboutDeprecation[componentName] || !didWarnAboutDeprecation[componentName][propName]) {
      didWarnAboutDeprecation[componentName] = _objectSpread$1(_objectSpread$1({}, didWarnAboutDeprecation[componentName]), {}, _defineProperty$2({}, propName, true));
      process.env.NODE_ENV !== "production" ? warning$1(false, message || "The prop `".concat(propName, "` has been deprecated for the ") + "".concat(componentName, " component. It will be removed in the next major ") + "release") : void 0;
    }
...
var Button$3 = /*#__PURE__*/React__default['default'].forwardRef(function Button(_ref, ref) {
  var _classNames;
  ...
  var children = _ref.children,
      ...
      other = _objectWithoutProperties$1(_ref, ["children", "as", "className", "disabled", "small", "size", "kind", "href", "isExpressive", "isSelected", "tabIndex", "type", "renderIcon", "dangerDescription", "iconDescription", "hasIconOnly", "tooltipPosition", "tooltipAlignment", "onClick", "onBlur", "onFocus", "onMouseEnter", "onMouseLeave"]);
  ...
  var closeTooltips = function closeTooltips(evt) {
    ...
    var tooltipNode = (_document = document) === null || _document === void 0 ? void 0 : _document.querySelectorAll(".".concat(prefix$1, "--tooltip--a11y"));

    _toConsumableArray$1(tooltipNode).map(function (node) {
      toggleClass(node, "".concat(prefix$1, "--tooltip--hidden"), node !== evt.currentTarget);
    });
  };
  ...
  var buttonClasses = classnames(className, (_classNames = {}, _defineProperty$1(_classNames, "".concat(prefix$1, "--btn"), true), _defineProperty$1(_classNames, "".concat(prefix$1, "--btn--sm"), size === 'small' && !isExpressive || size === 'sm' && !isExpressive || small && !isExpressive), _defineProperty$1(_classNames, "".concat(prefix$1, "--btn--md"), size === 'field' && !isExpressive || size === 'md' && !isExpressive), _defineProperty$1(_classNames, "".concat(prefix$1, "--btn--lg"), enabled ? size === 'xl' : size === 'lg'), _defineProperty$1(_classNames, "".concat(prefix$1, "--btn--xl"), enabled ? size === '2xl' : size === 'xl'), _defineProperty$1(_classNames, "".concat(prefix$1, "--btn--").concat(kind), kind), _defineProperty$1(_classNames, "".concat(prefix$1, "--btn--disabled"), disabled), _defineProperty$1(_classNames, "".concat(prefix$1, "--btn--expressive"), isExpressive), _defineProperty$1(_classNames, "".concat(prefix$1, "--tooltip--hidden"), hasIconOnly && !allowTooltipVisibility), _defineProperty$1(_classNames, "".concat(prefix$1, "--tooltip--visible"), isHovered), _defineProperty$1(_classNames, "".concat(prefix$1, "--btn--icon-only"), hasIconOnly), _defineProperty$1(_classNames, "".concat(prefix$1, "--btn--selected"), hasIconOnly && isSelected && kind === 'ghost'), _defineProperty$1(_classNames, "".concat(prefix$1, "--tooltip__trigger"), hasIconOnly), _defineProperty$1(_classNames, "".concat(prefix$1, "--tooltip--a11y"), hasIconOnly), _defineProperty$1(_classNames, "".concat(prefix$1, "--btn--icon-only--").concat(tooltipPosition), hasIconOnly && tooltipPosition), _defineProperty$1(_classNames, "".concat(prefix$1, "--tooltip--align-").concat(tooltipAlignment), hasIconOnly && tooltipAlignment), _classNames));
  var commonProps = {
    tabIndex: tabIndex,
  ...
  if (hasIconOnly) {
    ...
    assistiveText = /*#__PURE__*/React__default['default'].createElement("span", {
      id: assistiveId,
      className: "".concat(prefix$1, "--visually-hidden")
    }, dangerDescription);
  } else {
    assistiveText = null;
  }
...
var Button$2 = function Button(_ref) {
  var {
    ...
    otherText
      ...
      rest = _objectWithoutProperties$2(_ref, ["children", "otherText"]);

  return /*#__PURE__*/React__default['default'].createElement(Button$3, rest, children, " ", otherText);
};
